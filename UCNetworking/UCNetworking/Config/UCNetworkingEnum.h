...
typedef NS_ENUM(NSInteger, UCNetworkReachabilityStatus) {
    UCNetworkReachabilityStatusUnknown          = -1,
    UCNetworkReachabilityStatusNotReachable     = 0,
    UCNetworkReachabilityStatusReachableViaWWAN = 1,
    UCNetworkReachabilityStatusReachableViaWiFi = 2,
};
